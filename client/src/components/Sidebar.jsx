...
const Sidebar = () => {
  ...
  return (
    <div className='flex flex-col h-screen min-w-72 p-5
      ...
      {/* New Chat Button */}
      <button className='flex justify-center items-center w-fully py-2 mt-10
      ...
      <div>
        ...
        chat.name.toLowerCase().includes(search.toLowerCase())).map((chat)=>(
            <div key={chat._id} className='p-2 px-4 dark:bg-[#57317C]/10 border border-gray-300 dark:border-[#80609F]/15 rounded-md cursor-pointer
        ...
        {/* Community Images */}
        <div onClick={()=>{navigate('/community')}} className='flex items-center gap-2 p-3 mt-4 border 
        border-gray-300 dark:border-white/15 rounded-md cursor-pointer hover:scale-103 tranisition-all'>
        ...
        {/*user Account*/}
        <div  className='flex items-center gap-3 p-3 mt-4 border 
        border-gray-300 dark:border-white/15 rounded-md cursor-pointer group'>
